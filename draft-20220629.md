...
The server must implement a denylist. If it is part of a realm, it must honor, at minimum, the realm's shared denylist. See the section on realms, below, for more guidance.
